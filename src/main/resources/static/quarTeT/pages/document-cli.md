...
## Getting Started
### Dependencies
- Python3 (>3.6, tested on 3.7.4 and 3.9.12) (https://www.python.org/)
- Minimap2 (tested on 2.24-r1122 and 2.24-r1155-dirty) (https://github.com/lh3/minimap2)
- MUMmer4 (tested on 4.0.0rc1) (https://github.com/mummer4/mummer)
- trf (tested on 4.09) (https://github.com/Benson-Genomics-Lab/TRF)
- CD-hit (tested on 4.6 and 4.8.1) (https://github.com/weizhongli/cdhit)
- BLAST+ (tested on 2.8.1 and 2.11.0) (https://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/LATEST/)
- tidk (tested on 0.2.1) (https://github.com/tolkit/telomeric-identifier)
- gnuplot (tested on 4.6 patchlevel 2 and 6) (https://github.com/gnuplot/gnuplot)
- R (tested on 3.6.0) (https://www.R-project.org/)
    - RIdeogram (tested on 0.2.2)
### Installation
quarTeT do not require installation.
1. [Download quarTeT](https://www.atcgn.com/t2t/bioRepository/exec/quartet.tar.gz).
...
A haplotype-resloved contig-level assembly and a close-related reference genome are required as input, both in fasta format.

Note that contigs should be haplotype-resloved. 
...
Usage: python3 quartet.py AssemblyMapper <parameters>
  ...
  -q CONTIGS
                        (*Required) Haplotype solved contigs file, FASTA format.
...
### CentroMiner
CentroMiner is a centromere identification tool.
